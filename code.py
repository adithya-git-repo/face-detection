...
#sr_image = face_recognition.load_image_file("imgs_database/srmech.jpg")
#sr_fc = face_recognition.face_encodings(sr_image)[0]
...
known_face_encodings = [
    adi_fc,sars_fc,karti_fc,gk_fc,ismail_fc,sharn_fc,hari_fc
]

known_face_names = [
    "Adithya","Sheik Masthan","Karthick","Dr.G.Kanagaraj","Ismail","Sharanya","Harikrishna"
]
